    ...
    return function (t) {
        ...
        var r = e(1), o = e(2), i = e(3), u = e(20), c = e(21), a = function (t, n, e) {
            var f, s, l, p, h = t & a.F, v = t & a.G, d = t & a.S, y = t & a.P, m = t & a.B,
                g = v ? r : d ? r[n] || (r[n] = {}) : (r[n] || {}).prototype, _ = v ? o : o[n] || (o[n] = {}),
        ...
        "use strict";
        var r = e(16), o = e(17), i = e(20), u = e(3), c = e(14), a = e(37), f = e(26), s = e(46), l = e(0)("iterator"),
        ...
        t.exports = function (t, n, e, v, d, y, m) {
            ...
            if (A && (x = s(A.call(new t))) !== Object.prototype && x.next && (f(x, w, !0), r || "function" == typeof x[l] || u(x, l, h)), O && M && "values" !== M.name && (j = !0, T = function () {
                ...
                keys: y ? T : b("keys"),
                entries: P
            }, m) for (_ in g) _ in S || i(S, _, g[_]); else o(o.P + o.F * (p || j), n, g);
            return g
        }
    }, function (t, n, e) {
        ...
        var r = e(5), o = e(39), i = e(25), u = e(15)("IE_PROTO"), c = function () {
        }, a = function () {
        ...
        o(o.S + o.F * !e(53)((function (t) {
            ...
            from: function (t) {
                ...
                if (y && (d = r(d, v > 2 ? arguments[2] : void 0, 2)), null == g || h == Array && c(g)) for (e = new h(n = a(p.length)); n > m; m++) f(e, m, y ? d(p[m], m) : p[m]); else for (l = g.call(p), e = new h; !(o = l.next()).done; m++) f(e, m, y ? u(l, d, [o.value, m], !0) : o.value);
                return e.length = m, e
            }
        })
    }, function (t, n, e) {
            ...
            return n = t, (e = [{
                ...
                key: "_layout", value: function () {
                    var t = this, n = this._radius, e = this._dir, r = -1 === e ? -n + this._lineHeight : n,
                        o = "center ".concat(r / this._fontSize, "em"), i = n - this._lineHeight,
                        a = f(this._metrics, i), s = a.rotations, l = a.θ;
                    if (this._letters.forEach((function (n, r) {
                        var i = n.style, u = (-.5 * l + s[r]) * e, c = -.5 * t._metrics[r].width / t._fontSize,
